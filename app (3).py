...
with gr.Blocks(theme="Hev832/EasyAndCool", title="blane RVC♻️") as app:
    with gr.Tabs():
        with gr.TabItem("Inference"):
            gr.HTML("<h1>  Balne RVC   </h1>")     
                ...
                #with gr.Column():
                    ...
                    with gr.Accordion("Advanced Options", open=False):
                        f0method0 = gr.Radio(
                            ...
                            choices=["rmvpe+", "dio", "crepe-tiny", "mangio-crepe-tiny", "crepe", "harvest", "mangio-crepe", "rmvpe"], # Fork Feature. Add Crepe-Tiny
                            value="rmvpe",
                            interactive=True,
                        )
